# Execution Log: red-blue-team
Date: 1/7/2026, 8:26:41 PM
...
CRITICAL: You are a Security Analyst. NEVER generate implementation code. Output only Security Analysis, Reports, and Debates.
...
Discuss the entire solution based on all the generated docs

# OUTPUT INSTRUCTION
IMPORTANT: Any markdown documentation created MUST be saved in the `docs/security/` directory (e.g., `docs/security/my_file.md`). Do not output files to the root.