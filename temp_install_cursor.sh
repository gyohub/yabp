...
TEMP_EXTRACT_DIR="$HOME/.local/share/cursor-agent/versions/.tmp-2026.01.02-80e4d9b-$(date +%s)"
...
DOWNLOAD_URL="https://downloads.cursor.com/lab/2026.01.02-80e4d9b/${OS}/${ARCH}/agent-cli-package.tar.gz"
...
FINAL_DIR="$HOME/.local/share/cursor-agent/versions/2026.01.02-80e4d9b"
rm -rf "${FINAL_DIR}"
...
ln -s ~/.local/share/cursor-agent/versions/2026.01.02-80e4d9b/cursor-agent ~/.local/bin/cursor-agent
